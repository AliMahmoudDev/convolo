  ...
  return (
    <footer className="border-t border-[var(--border-default)] bg-[var(--bg-surface)]">
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 sm:py-16 lg:px-8">
        <div className="mb-12 grid grid-cols-1 gap-10 md:grid-cols-4">
          ...
          <div className="md:col-span-1">
            ...
            <p className="max-w-[240px] text-sm leading-relaxed text-[var(--text-secondary)]">
              Conversation, Unlocked. Master any language through real conversations with AI.
            </p>
          </div>
        ...
        {/* Bottom bar */}
        <div className="flex flex-col items-center justify-between gap-4 border-t border-[var(--border-default)] pt-8 sm:flex-row">
